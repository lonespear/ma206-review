...
def run_quiz_form(salary_per_question=400_000):
    ...
    with st.form("salary_quiz_form"):
        ...
        questions = {
            ...
            8: {"question": "Which condition ensures t-procedures are valid with small samples?",
                "options": ["Population is roughly normal", "Sample size > 30", "Equal sample sizes", "Large proportion counts"],
                "answer": "Population is roughly normal",
                "explanation": "T-tests assume the underlying population is approximately normal when n is small."},
            9: {"question": "A variable records whether a cadet passed their ACFT. What type of variable is this?",
            ...
            17: {"question": "Which study design best supports causal conclusions?",
                "options": ["Randomized experiment", "Observational study", "Cohort study", "Cross-sectional survey"],
